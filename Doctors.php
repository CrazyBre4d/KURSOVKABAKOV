                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> info@hospital.com</a></li>
                                    <li><a href="#"> <i class="fa fa-phone"></i> +375251030303</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        ...
                        <p><a href="index.html">Главная /</a> О специалистах</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="single_expert mb-40">
                        <div class="expert_thumb">
                            <img src="<?php echo $data['spec_image'] ?>" alt="">
                        </div>
                        <div class="experts_name text-center">
                            <h3><?php echo $data['spec_name']?></h3>
                            <span><?php echo $data['spec_text']?></span>
                        </div>
                    </div>
                </div>
                <?php endforeach;  ?>
